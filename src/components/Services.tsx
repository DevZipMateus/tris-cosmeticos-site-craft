        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => {
            ...
            return (
              <div
                key={service.title}
                className="card-elevated p-6 rounded-xl animate-slide-up hover:scale-105 transition-all duration-300"
              ...
              >
                ...
                <a
                  ...
                  className="btn-secondary w-full text-center py-2 rounded-lg block"
                  target="_blank"
        ...
        <div className="text-center mt-16">
          <div className="bg-gradient-to-r from-primary to-accent p-8 rounded-2xl text-white">
            ...
            <a
              ...
              className="bg-white text-primary px-8 py-3 rounded-lg font-bold hover:bg-white/90 transition-colors inline-block"
              target="_blank"
              rel="noopener noreferrer"
            >
              Agendar Consulta
